    ...
    public class HomeController : Controller
    {
       ...
       [HttpGet("/actividad/{ActividadId}")]
        public IActionResult Actividades(int ActividadId)
        {
            ...
            ViewBag.AllGuests = dbContext.GuestLists.Include(i => i.Guest).Where(i => i.ActividadId == ActividadId);
            ViewBag.PlannedAct = dbContext.Actividads.Include(i => i.Creator).FirstOrDefault(i => i.ActividadId == ActividadId);
            ViewBag.CurrentUser = dbContext.Users.FirstOrDefault(i => i.UserId == (int)session);
